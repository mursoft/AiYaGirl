...
public class NavAboutActivity extends BaseActivity {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mTvVersionName.setText(String.valueOf("当前版本 V" + PackageUtil.getVersionName()));
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_gankio:
                intent = new Intent(this, WebViewActivity.class);
                intent.putExtra(WebViewActivity.GANK_TITLE, "拿着Api去玩耍");
                intent.putExtra(WebViewActivity.GANK_URL, getResources().getString(R.string.string_url_gankio));
                startActivity(intent);
                break;
        }
    }
